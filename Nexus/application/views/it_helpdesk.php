    ...
    $(document).ready(function() {
        $('#table').change(function(){
            ...
            if(cid ==null){
                ...
                window.location = "<?php echo site_url('it_helpdesk/index');?>/"+cid;
            }
...
<div class="inner_section">
    <div class="emp_listing mb12">
        <h3>
            IT Help Desk
            <a href="<?php echo site_url('it_policies');?>" class="link" style="float:right;">IT POLICIES</a>
        ...
        <div class="emp_det_list">
			...
			<?php 
            if($ithelpdetails){
            foreach($ithelpdetails as $it_details){?>
                <li>
                    <div class="clearfix">
                        <div class="">
                            <div class="clearfix bir_desc_up">
                                <div class="birt_info">
									...
									<?php echo $it_details->name; ?> - <?php echo $it_details->designation; ?></span>
                                </div>
                                <span class="birt_date">
                                                                                                                         extn no: <?php echo $it_details->extn;?>
                                </span>
                            </div>
                            <div class="clearfix bir_desc_down">
                                <div class="birt_desc">
                                    <span class="birt_designation">
                                        Contact For - <?php echo $it_details->contactfor; ?>
                                    </span>
                                </div>
                            </div>
                        </div>
