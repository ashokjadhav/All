 ...
 $(document).ready(function() {
    $(".status").live("click", function(){
        ...
        $.ajax({
                type: "POST",
                dataType: "json",
                url: baseURL+"admin/vision_mission/set_status/"+id,
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: baseURL+"admin/vision_mission/unset_status/"+id,
                success: function(response) {
                    // success function is called when data came back
                    // for example: get your content and display it on your site
                    //alert(response);
...
<div id="main_content">
            ...
            <h2 class="grid_12">Videos
                <div style="float:right;margin-right:5%;">
                    <a href="<?php echo site_url('admin/vision_mission/add') ?>"><font size=2>Add Video</font></a>
                </div></h2>
            <div class="grid_12">
                <div class="box">
                    <div class="header">
...
<form name="frmproducts" id="frmproducts" method="post">
 ...
 <?php if($slide['status']=='1'){?>checked<?php }?>>
                      ...
                      <a class="delete tooltip" href="javascript: void(0)'" title="Delete Item" onclick="javascript : deleteConfirm('<?php echo site_url("admin/vision_mission/delete/".$slide['id']); ?>');"><img src='<?php echo base_url(); ?>/design/Template/img/icons/packs/diagona/16x16/101.png'/></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
...
<?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   ...
					   <?php } else if(is_array($priv['vision_mission'])&& in_array(3,$priv['vision_mission'])){
						?>
                       <?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   <?php } ?> </form>
