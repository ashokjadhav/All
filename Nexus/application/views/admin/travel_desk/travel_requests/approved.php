<script>
 ...
 <div id="main_content">
        ...
        <h2 class="grid_12">Booked Tickets
        ...
        <div class="box">
            <div class="header">
                    ...
                    <h3>Booked Tickets</h3><span></span>
            </div>
            <div class="content">
            ...
            <table id="table-example" class="table">
                ...
                <?php foreach ($approvedtickets_managementDetails as $request): ?>
                    <tr>
                        ...
                        <td><?php echo $request['band_grade']; ?></td>
                        <td>
                            <a href="#" class="view-answer" id="<?php echo $request['id']; ?>">View</a>
                            <div class="dialog" id="dialog_<?php echo $request['id']; ?>" title="Name: <?php echo $request['name']; ?>"  style="display:none;">
                        ...
                        <td>
                                <a class="delete tooltip" href="javascript: void(0)'" title="Delete Item" onclick="javascript : deleteConfirm('<?php echo site_url("admin/ticket_approved/delete/".$table.'/'.$request['id']); ?>');"><img src='<?php echo base_url(); ?>/design/Template/img/icons/packs/diagona/16x16/101.png'/></a>
                        </td>
                    </tr>
                        <?php endforeach;?>
                </tbody>
                    ...
                    <?php $priv = $this->session->userdata('privileges');
                            if($priv=='All') {?>
                                    ...
                                    <?php } else if(is_array($priv['ticket_approved'])&& in_array(3,$priv['ticket_approved'])){
                                    ?>
                                    <?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
                                    <?php } ?>
                    </form>
