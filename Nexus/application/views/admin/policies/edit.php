    ...
    <center>
        <div class="grid_6" style="width:95%;">
            ...
            <div class="box">
                ...
                <form id="frm" method="post" class="validate" action="<?php echo site_url('admin/policies/edit/'.$this->uri->segment(4,0));?>" enctype="multipart/form-data">
...
<?php echo form_error('title'); ?>
            ...
            <div class="section _100">
                     ...
                     <div>
                            <textarea name="desc" id="desc"  class="ckeditor" style="width:50%;resize:none;"><?php if (isset($policiesDetailsArr[0]['desc'])) {
