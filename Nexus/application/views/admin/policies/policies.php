...
<form name="frmproducts" id="frmproducts" method="post">
        ...
        <p><span style="font-family:verdana,geneva,sans-serif; font-size:14px; text-align:justify"> <?php echo $policy['desc']; ?></span></p>
                                       ...
                                       <td>
                                        ...
                                        <td>
                                            <a title="Edit Item" href="<?php echo site_url('admin/policies/edit/' . $policy['id'] ); ?>"><img src='<?php echo base_url(); ?>/design/Template/img/icons/packs/diagona/16x16/019.png'/></a>&nbsp; | &nbsp;

                      <a class="delete tooltip" href="javascript: void(0)'" title="Delete Item" onclick="javascript : deleteConfirm('<?php echo site_url("admin/policies/delete/".$policy['id']); ?>');"><img src='<?php echo base_url(); ?>/design/Template/img/icons/packs/diagona/16x16/101.png'/></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
...
<?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   ...
					   <?php } else if(is_array($priv['policies'])&& in_array(3,$priv['policies'])){
						?>
                       <?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   <?php } ?></form>
