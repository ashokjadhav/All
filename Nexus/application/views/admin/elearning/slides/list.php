 ...
 $(document).ready(function() {
    $(".status").live("click", function(){
        ...
        $.ajax({
                type: "POST",
                dataType: "json",
                url: baseURL+"admin/elearning_slides/set_status/"+id,
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: baseURL+"admin/elearning_slides/unset_status/"+id,
                success: function(response) {
                    // success function is called when data came back
                    // for example: get your content and display it on your site
                    //alert(response);
...
<div id="main_content">
            ...
            <h2 class="grid_12">Slides & Pdf
                <div style="float:right;margin-right:5%;">
                    <a href="<?php echo site_url('admin/elearning_slides/add') ?>"><font size=2>Add Slide/Pdf</font></a>
                </div></h2>
            <div class="grid_12">
                <div class="box">
                    <div class="header">
                        <img src="<?php echo base_url(); ?>/design/Template/img/icons/packs/fugue/16x16/report--pencil.png" width="16" height="16">
                        <h3>Slides & Pdf</h3><span></span>
                    </div>
                    <div class="content">
...
<form name="frmproducts" id="frmproducts" method="post">
                        <table id="table-example" class="table">
                            ...
                            <tbody>
                                <?php $x = 1; ?>
                                <?php foreach($slidesDetails as $slide):?>
 ...
 <?php if($slide['status']=='1'){?>checked<?php }?>>
                                        ...
                                        <td>
										<a title="Edit Item" href="<?php echo site_url('admin/elearning_slides/edit/'.$slide['id']); ?>"><img src='<?php echo base_url(); ?>/design/Template/img/icons/packs/diagona/16x16/019.png'/></a>&nbsp; | &nbsp;
                      <a class="delete tooltip" href="javascript: void(0)'" title="Delete Item" onclick="javascript : deleteConfirm('<?php echo site_url("admin/elearning_slides/delete/".$slide['id']); ?>');"><img src='<?php echo base_url(); ?>/design/Template/img/icons/packs/diagona/16x16/101.png'/></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
...
<?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   ...
					   <?php } else if(is_array($priv['elearning_slides'])&& in_array(3,$priv['elearning_slides'])){
						?>
                       <?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   <?php } ?> </form>
