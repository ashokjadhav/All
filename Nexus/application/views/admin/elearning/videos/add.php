...
<div id="main_content">
	<h2 class="grid_12">
		...
		<div style="float:right;margin-right:5%;">
			<a href="<?php echo site_url('admin/elearning_videos/') ?>"><font size=2> List</font>
			</a>
		</div>
	</h2>
    <div class="clean"></div>
   ...
   <?php echo form_open_multipart('admin/elearning_videos/add',array('class'=>'validate'));?>
			...
			<label>Title :</label>
				<div>
					...
					<div class="section _100">
						...
						<div>
							<input style='width:10%;float:left;'type="checkbox" name="copyrights" class="chkbox">
