<script>
 $(document).ready(function() {
    ...
    $(".status").live("click", function(){
        ...
        $.ajax({
                type: "POST",
                dataType: "json",
                url: baseURL+"admin/quiz_subcategory/set_status/"+id,
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: baseURL+"admin/quiz_subcategory/unset_status/"+id,
                success: function(response) {
                    // success function is called when data came back
                    // for example: get your content and display it on your site
                    //alert(response);
 ...
 <div id="main_content">
            ...
            <h2 class="grid_12">Quiz SubCategory
                <div style="float:right;margin-right:5%;">
                    <a href="<?php echo site_url('admin/quiz_subcategory/add') ?>"><font size=2>Add New</font></a>
                </div></h2>
            <div class="grid_12">
                <div class="box">
                    <div class="header">
            ...
            <form name="frmproducts" id="frmproducts" method="post">
                        <table id="table-example" class="table">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($subcategoryDetails as $resource): ?>
                                    <tr>
                                       <td><input type="checkbox" value="<?php echo $resource['id']; ?>" name="delete[]" class="chkbox"></td>
                                        ...
                                        <td>
                                            <?php echo $resource['sub_category']; ?>
                                        ...
                                        <td>
                                            <a title="Edit Item" href="<?php echo site_url('admin/quiz_subcategory/edit/'.$resource['id']); ?>"><img src='<?php echo base_url(); ?>/design/Template/img/icons/packs/diagona/16x16/019.png'/></a>&nbsp; | &nbsp;
                                            <a class="delete tooltip" href="javascript: void(0)'" title="Delete Item" onclick="javascript : deleteConfirm('<?php echo site_url("admin/quiz_subcategory/delete/".$resource['id']); ?>');"><img src='<?php echo base_url(); ?>/design/Template/img/icons/packs/diagona/16x16/101.png'/></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
...
<?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   ...
					   <?php } else if(is_array($priv['quiz_subcategory'])&& in_array(3,$priv['quiz_subcategory'])){
						?>
                       <?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   <?php } ?></form>
