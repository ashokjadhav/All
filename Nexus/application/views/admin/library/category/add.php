...
<?php if ($this->session->flashdata('error')) { ?>
    ...
    <center>
        <div class="grid_6" style="width:95%;">
            ...
            <div class="box">
                <div class="header">
                    <img src="<?php echo base_url(); ?>design/Template/img/icons/packs/fugue/16x16/book--plus.png" alt="" width="16"
                         height="16">
                    <h3>Category</h3>
                    <span></span>
                </div>
                <form id="frm" method="post" class="validate" action="<?php echo site_url('admin/category/add');?>" enctype="multipart/form-data">
