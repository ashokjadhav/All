<script>
 $(document).ready(function() {
    ...
    $(".status").live("click", function(){
        ...
        $.ajax({
                type: "POST",
                dataType: "json",
                url: baseURL+"admin/sub_category/set_status/"+id,
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: baseURL+"admin/sub_category/unset_status/"+id,
                success: function(response) {
                    // success function is called when data came back
                    // for example: get your content and display it on your site
                    //alert(response);
 ...
 <div id="main_content">
            ...
            <h2 class="grid_12">SubCategory
                <div style="float:right;margin-right:5%;">
                    <a href="<?php echo site_url('admin/sub_category/add') ?>"><font size=2>Add New</font></a>
                </div></h2>
            <div class="grid_12">
                <div class="box">
                    <div class="header">
                                ...
                                <?php foreach ($subcategoryDetails as $resource): ?>
                                    <tr>
                                       <td><input type="checkbox" value="<?php echo $resource['id']; ?>" name="delete[]" class="chkbox"></td>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('admin/sub_category/edit/'.$resource['id']); ?>"><img src='<?php echo base_url(); ?>/design/Template/img/icons/packs/diagona/16x16/019.png'/></a>&nbsp; | &nbsp;
                                            <a class="delete tooltip" href="javascript: void(0)'" title="Delete Item" onclick="javascript : deleteConfirm('<?php echo site_url("admin/sub_category/delete/".$resource['id']); ?>');"><img src='<?php echo base_url(); ?>/design/Template/img/icons/packs/diagona/16x16/101.png'/></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
...
<?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   ...
					   <?php } else if(is_array($priv['sub_category'])&& in_array(3,$priv['sub_category'])){
						?>
                       <?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   <?php } ?></form>
