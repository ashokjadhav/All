<script>
 $(document).ready(function() {
     ...
     $('#table_name').change(function(){
			...
			window.location = "<?php echo site_url('admin/lost/index');?>/"+table_name;
		})
 ...
 <div id="main_content">
      ...
      <select id="table_name" class="table_name" style="width:30%;">
            ...
            <h2 class="grid_12">Lost Items List
      ...
      <form name="frmproducts" id="frmproducts" method="post">
                        <table id="table-example" class="table">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($lostDetails as $lost): ?>
                                    <tr>
                                       <td><input type="checkbox" value="<?php echo $lost['id']; ?>" name="delete[]"></td>
                                        <td><?php echo $x++; ?></td>
                                         <td>
                                           <a href="#" class="view-answer" id="<?php echo $lost['id']; ?>">View</a>
										<div class="dialog" id="dialog_<?php echo $lost['id']; ?>" title="<?php echo $lost['name']; ?>"  style="display:none;">
	<table  class="table" bgcolor=#bebebe border=1 width=80% height=80%>
		...
		<tr>
			...
			<td><span style="font-size:14px"><?php echo $lost['category']; ?></span></td>
		</tr>
		<tr>
			<td><span style="font-size:14px"><strong>Code Number</strong></span></td>
			<td><span style="font-size:14px"><?php echo $lost['code']; ?></span></td>
		</tr>
		<tr>
			<td><span style="font-size:14px"><strong>Price</strong></span></td>
			<td><span style="font-size:14px">Rs. <?php echo $lost['price']; ?>/-</span></td>
		</tr>
	</table>
									</td>
                                        ...
                                        <td>
                                            <?php echo $lost['subscriber']; ?>
                                        </td>

                                        <td>
                                            <?php echo $lost['department']; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
...
<?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   ...
					   <?php } else if(is_array($priv['lost'])&& in_array(3,$priv['lost'])){
						?>
                       <?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   <?php } ?></form>
