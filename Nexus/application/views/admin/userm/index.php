 ...
 $(document).ready(function() {
    ...
    $(".status").live("click", function(){
        ...
        $.ajax({
                type: "POST",
                dataType: "json",
                url: baseURL+"admin/usermanagement/set_status/"+id,
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: baseURL+"admin/usermanagement/unset_status/"+id,
                success: function(response) {
                    // success function is called when data came back
                    // for example: get your content and display it on your site
                    //alert(response);
 ...
 <div id="main_content">
            ...
            <h2 class="grid_12">User Management
                <div style="float:right;margin-right:5%;">
                    <a href="<?php echo site_url('admin/usermanagement/add') ?>"><font size=2>Add User</font></a>
                </div></h2>
            <div class="grid_12">
                <div class="box">
                    <div class="header">
            ...
            <form name="frmproducts" id="frmproducts" method="post">
                        <table id="table-example" class="table">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($user_data as $resource): ?>    
                                    <tr>
                                        ...
                                        <td>
                                            <a title="Edit Item" href="<?php echo site_url('admin/usermanagement/edit/'. $resource['id']); ?>"><img src='<?php echo base_url(); ?>/design/Template/img/icons/packs/diagona/16x16/019.png'/></a>&nbsp; | &nbsp;
                                            <a class="delete tooltip" href="javascript: void(0)'" title="Delete Item" onclick="javascript : deleteConfirm('<?php echo site_url("admin/usermanagement/delete/".$resource['id']); ?>');"><img src='<?php echo base_url(); ?>/design/Template/img/icons/packs/diagona/16x16/101.png'/></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
