 ...
 $(document).ready(function() {
	 $(".status").live("click", function(){
        ...
        $.ajax({
                type: "POST",
                dataType: "json",
                url: baseURL+"admin/utsav/set_status/"+id,
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: baseURL+"admin/utsav/unset_status/"+id,
                success: function(response) {
                    // success function is called when data came back
                    // for example: get your content and display it on your site
                    //alert(response);
 ...
 function deleteConfirm(url)
 {
 	if(confirm('Do you want to Delete?'))
 	{
        ...
        <div id="main_content">
            ...
            <h2 class="grid_12">Utsav Newsletter
                <div style="float:right;margin-right:5%;">
                    <a href="<?php echo site_url('admin/utsav/add') ?>"><font size=2>Add Utsav</font></a>
                </div></h2>
            <div class="grid_12">
                <div class="box">
                    <div class="header">
                        <img src="<?php echo base_url(); ?>/design/Template/img/icons/packs/fugue/16x16/shadeless/document-pdf.png" width="16" height="16">
                        <h3>Utsav Newsletter</h3><span></span>
                    </div>
                    <div class="content">
                        ...
                        <table id="table-example" class="table">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($utsavDetails as $hrhelp): ?>
                                    <tr>
                                       <td><input type="checkbox" value="<?php echo $hrhelp['id']; ?>" name="delete[]"></td>
										...
										<td>
                                       <a title='Download' href="<?php echo site_url('admin/utsav/download/'.$hrhelp['id']) ?>"><font size=2><?php echo $hrhelp['form'];?>
									   </font></a>
                                        </td>
										...
										<td>
										 ...
										 <td>
                                            <a title="Edit Item" href="<?php echo site_url('admin/utsav/edit/'. $hrhelp['id']); ?>"><img src='<?php echo base_url(); ?>/design/Template/img/icons/packs/diagona/16x16/019.png'/></a>&nbsp; | &nbsp;
...
<?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   ...
					   <?php } else if(is_array($priv['utsav'])&& in_array(3,$priv['utsav'])){
						?>
                       <?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   <?php } ?></form>
