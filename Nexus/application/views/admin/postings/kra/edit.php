        ...
        <div id="main_content">
          ...
          <div class="grid_6" style="width:95%;">
            ...
            <div class="box">
              ...
              <?php echo form_open('admin/kra/edit/'.$this->uri->segment(4, 0), array('class' => 'validate')); ?>
                ...
                <div class="content no-padding">
                  <div class="section _100">
                     <label>
                        ...
                        <div>
                            <input type="text" class="required" id="name" value="<?php if (isset($krasDetailsArr[0]['name'])) {
                            echo $krasDetailsArr[0]['name'];
                        } else {
                            echo set_value('name');
                        } ?>" name="name">
<?php echo form_error('name'); ?>
<input type="hidden" name="empid" id="empid" value="<?php echo $krasDetailsArr[0]['user_id'];?>">
                        </div>
                  </div>
                  ...
                  <div class="section _100">
                     <label>
                        ...
                        <div>
                             <textarea id="desc" rows="5" cols="40" name="details" class="ckeditor"><?php if (isset($krasDetailsArr[0]['details'])) {
                            echo $krasDetailsArr[0]['details'];
                        } else {
