 ...
 $(document).ready(function() {
	 $(".status").live("click", function(){
        ...
        $.ajax({
                type: "POST",
                dataType: "json",
                url: baseURL+"admin/location/set_status/"+id,
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: baseURL+"admin/location/unset_status/"+id,
                success: function(response) {
                    // success function is called when data came back
                    // for example: get your content and display it on your site
                    //alert(response);
...
<div id="main_content">
            ...
            <h2 class="grid_12">Locations
                <div style="float:right;margin-right:5%;">
                    <a href="<?php echo site_url('admin/location/add') ?>"><font size=2>Add Locations</font></a>
                </div></h2>
            <div class="grid_12">
                <div class="box">
                    <div class="header">
                                ...
                                <?php foreach($locationDetails as $location):?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         <td>
										 <a href="#" class="view-answer" id="<?php echo $location['id']; ?>">View</a>
										<div class="dialog" id="dialog_<?php echo $location['id']; ?>" title="<?php echo $location['city']; ?>"  style="display:none;">
				<p><span style="font-family:verdana,geneva,sans-serif; font-size:14px"> <?php echo $location['address']; ?></span></p>
                                        </td>
										<td>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('admin/location/edit/' . $location['id'] ); ?>"><img src='<?php echo base_url(); ?>/design/Template/img/icons/packs/diagona/16x16/019.png'/></a>&nbsp; | &nbsp;

                      <a class="delete tooltip" href="javascript: void(0)'" title="Delete Item" onclick="javascript : deleteConfirm('<?php echo site_url("admin/location/delete/".$location['id']); ?>');"><img src='<?php echo base_url(); ?>/design/Template/img/icons/packs/diagona/16x16/101.png'/></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
...
<?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   ...
					   <?php } else if(is_array($priv['location'])&& in_array(3,$priv['location'])){
						?>
                       <?php echo form_button(array('name'=>'mysubmit','id'=>'mysubmit'), 'Delete');?>
					   <?php } ?></form>
