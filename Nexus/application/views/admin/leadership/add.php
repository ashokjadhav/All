    ...
    <center>
        <div class="grid_6" style="width:95%;">
            ...
            <div class="box">
                ...
                <form id="frm" method="post" class="validate" action="<?php echo site_url('admin/leadership/add');?>" enctype="multipart/form-data">
                ...
                <div class="content no-padding">
					...
					<div class="section _100">
                        ...
                        <div>
                            <input type="text" name="post" id="post" class="required" value=""/>
                        </div>
                    </div>
					<div class="section _100">
                        <label>
